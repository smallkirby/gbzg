...
pub fn cb_decode(cpu: *Cpu, bus: *Peripherals) void {
    switch (cpu.ctx.opcode) {
        ...
        0x0F, 0x1F, 0x2F, 0x3F => unreachable,
        0x40 => inst.bit(cpu, bus, .{ .bit = 0 }, .{ .reg8 = .B }),
        0x50 => inst.bit(cpu, bus, .{ .bit = 2 }, .{ .reg8 = .B }),
        0x60 => inst.bit(cpu, bus, .{ .bit = 4 }, .{ .reg8 = .B }),
        0x70 => inst.bit(cpu, bus, .{ .bit = 6 }, .{ .reg8 = .B }),
        0x41 => inst.bit(cpu, bus, .{ .bit = 0 }, .{ .reg8 = .C }),
        0x51 => inst.bit(cpu, bus, .{ .bit = 2 }, .{ .reg8 = .C }),
        0x61 => inst.bit(cpu, bus, .{ .bit = 4 }, .{ .reg8 = .C }),
        0x71 => inst.bit(cpu, bus, .{ .bit = 6 }, .{ .reg8 = .C }),
        0x42 => inst.bit(cpu, bus, .{ .bit = 0 }, .{ .reg8 = .D }),
        0x52 => inst.bit(cpu, bus, .{ .bit = 2 }, .{ .reg8 = .D }),
        0x62 => inst.bit(cpu, bus, .{ .bit = 4 }, .{ .reg8 = .D }),
        0x72 => inst.bit(cpu, bus, .{ .bit = 6 }, .{ .reg8 = .D }),
        0x43 => inst.bit(cpu, bus, .{ .bit = 0 }, .{ .reg8 = .E }),
        0x53 => inst.bit(cpu, bus, .{ .bit = 2 }, .{ .reg8 = .E }),
        0x63 => inst.bit(cpu, bus, .{ .bit = 4 }, .{ .reg8 = .E }),
        0x73 => inst.bit(cpu, bus, .{ .bit = 6 }, .{ .reg8 = .E }),
        0x44 => inst.bit(cpu, bus, .{ .bit = 0 }, .{ .reg8 = .H }),
        0x54 => inst.bit(cpu, bus, .{ .bit = 2 }, .{ .reg8 = .H }),
        0x64 => inst.bit(cpu, bus, .{ .bit = 4 }, .{ .reg8 = .H }),
        0x74 => inst.bit(cpu, bus, .{ .bit = 6 }, .{ .reg8 = .H }),
        0x45 => inst.bit(cpu, bus, .{ .bit = 0 }, .{ .reg8 = .L }),
        0x55 => inst.bit(cpu, bus, .{ .bit = 2 }, .{ .reg8 = .L }),
        0x65 => inst.bit(cpu, bus, .{ .bit = 4 }, .{ .reg8 = .L }),
        0x75 => inst.bit(cpu, bus, .{ .bit = 6 }, .{ .reg8 = .L }),
        0x46 => inst.bit(cpu, bus, .{ .bit = 0 }, .{ .indirect = .HL }),
        0x56 => inst.bit(cpu, bus, .{ .bit = 2 }, .{ .indirect = .HL }),
        0x66 => inst.bit(cpu, bus, .{ .bit = 4 }, .{ .indirect = .HL }),
        0x76 => inst.bit(cpu, bus, .{ .bit = 6 }, .{ .indirect = .HL }),
        0x47 => inst.bit(cpu, bus, .{ .bit = 0 }, .{ .reg8 = .A }),
        0x57 => inst.bit(cpu, bus, .{ .bit = 2 }, .{ .reg8 = .A }),
        0x67 => inst.bit(cpu, bus, .{ .bit = 4 }, .{ .reg8 = .A }),
        0x77 => inst.bit(cpu, bus, .{ .bit = 6 }, .{ .reg8 = .A }),
        0x48 => inst.bit(cpu, bus, .{ .bit = 1 }, .{ .reg8 = .B }),
        0x58 => inst.bit(cpu, bus, .{ .bit = 3 }, .{ .reg8 = .B }),
        0x68 => inst.bit(cpu, bus, .{ .bit = 5 }, .{ .reg8 = .B }),
        0x78 => inst.bit(cpu, bus, .{ .bit = 7 }, .{ .reg8 = .B }),
        0x49 => inst.bit(cpu, bus, .{ .bit = 1 }, .{ .reg8 = .C }),
        0x59 => inst.bit(cpu, bus, .{ .bit = 3 }, .{ .reg8 = .C }),
        0x69 => inst.bit(cpu, bus, .{ .bit = 5 }, .{ .reg8 = .C }),
        0x79 => inst.bit(cpu, bus, .{ .bit = 7 }, .{ .reg8 = .C }),
        0x4A => inst.bit(cpu, bus, .{ .bit = 1 }, .{ .reg8 = .D }),
        0x5A => inst.bit(cpu, bus, .{ .bit = 3 }, .{ .reg8 = .D }),
        0x6A => inst.bit(cpu, bus, .{ .bit = 5 }, .{ .reg8 = .D }),
        0x7A => inst.bit(cpu, bus, .{ .bit = 7 }, .{ .reg8 = .D }),
        0x4B => inst.bit(cpu, bus, .{ .bit = 1 }, .{ .reg8 = .E }),
        0x5B => inst.bit(cpu, bus, .{ .bit = 3 }, .{ .reg8 = .E }),
        0x6B => inst.bit(cpu, bus, .{ .bit = 5 }, .{ .reg8 = .E }),
        0x7B => inst.bit(cpu, bus, .{ .bit = 7 }, .{ .reg8 = .E }),
        0x4C => inst.bit(cpu, bus, .{ .bit = 1 }, .{ .reg8 = .H }),
        0x5C => inst.bit(cpu, bus, .{ .bit = 3 }, .{ .reg8 = .H }),
        0x6C => inst.bit(cpu, bus, .{ .bit = 5 }, .{ .reg8 = .H }),
        0x7C => inst.bit(cpu, bus, .{ .bit = 7 }, .{ .reg8 = .H }),
        0x4D => inst.bit(cpu, bus, .{ .bit = 1 }, .{ .reg8 = .L }),
        0x5D => inst.bit(cpu, bus, .{ .bit = 3 }, .{ .reg8 = .L }),
        0x6D => inst.bit(cpu, bus, .{ .bit = 5 }, .{ .reg8 = .L }),
        0x7D => inst.bit(cpu, bus, .{ .bit = 7 }, .{ .reg8 = .L }),
        0x4E => inst.bit(cpu, bus, .{ .bit = 1 }, .{ .indirect = .HL }),
        0x5E => inst.bit(cpu, bus, .{ .bit = 3 }, .{ .indirect = .HL }),
        0x6E => inst.bit(cpu, bus, .{ .bit = 5 }, .{ .indirect = .HL }),
        0x7E => inst.bit(cpu, bus, .{ .bit = 7 }, .{ .indirect = .HL }),
        0x4F => inst.bit(cpu, bus, .{ .bit = 1 }, .{ .reg8 = .A }),
        0x5F => inst.bit(cpu, bus, .{ .bit = 3 }, .{ .reg8 = .A }),
        0x6F => inst.bit(cpu, bus, .{ .bit = 5 }, .{ .reg8 = .A }),
        0x7F => inst.bit(cpu, bus, .{ .bit = 7 }, .{ .reg8 = .A }),
