...
pub fn decode(cpu: *Cpu, bus: *Peripherals) void {
    switch (cpu.ctx.opcode) {
        ...
        0x09 => inst.add_hl(cpu, bus, .{ .reg16 = .BC }),
        0x19 => inst.add_hl(cpu, bus, .{ .reg16 = .DE }),
        0x29 => inst.add_hl(cpu, bus, .{ .reg16 = .HL }),
        0x39 => inst.add_hl(cpu, bus, .{ .reg16 = .SP }),
        ...
        0xD3, 0xE3 => inst.unimplemented_inst(cpu, bus),
        0xF3 => inst.di(cpu, bus),
        0xC4 => inst.callc(cpu, bus, .NZ),
        0xD4 => inst.callc(cpu, bus, .NC),
        0xE4 => inst.unimplemented_inst(cpu, bus),
        0xF4 => inst.unimplemented_inst(cpu, bus),
        ...
        0xE8 => inst.add_sp(cpu, bus),
        0xF8 => inst.ld_hlsp(cpu, bus),
        ...
        0xDB, 0xEB => inst.unimplemented_inst(cpu, bus),
        0xFB => inst.ei(cpu, bus),
        0xCC => inst.callc(cpu, bus, .Z),
        0xDC => inst.callc(cpu, bus, .C),
        0xEC, 0xFC => inst.unimplemented_inst(cpu, bus),
        0xCD => inst.call(cpu, bus),
        0xDD, 0xED, 0xFD => inst.unimplemented_inst(cpu, bus),
